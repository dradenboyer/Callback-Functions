...
// CODE HERE
const multiply = (x,y,multiplyTwo) => {
  return multiplyTwo(x*y)
}
// const answer = (x,y) => {
//   return (x * y)
// }
...
// CODE HERE
const last = (names,firstName) => {
  return firstName(names[names.length -1])
}
...
console.log(`The item at index ${index} is ${items}.`)
})
